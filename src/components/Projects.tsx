...
const projects = [
  ...
  },
  {
    ...
    kicker: "Paper and reproducibility artifact",
    description: "Revised manuscripts, standalone implementation, routing tests and matched evidence for the shared-SwiGLU plus fixed top-2 residual architecture.",
    tags: ["Paper", "306.5M", "Reproducibility"],
    href: "https://github.com/Complexity-ML/tmlr-paper-pool",
    icon: Network,
    tone: "emerald",
  },
  {
