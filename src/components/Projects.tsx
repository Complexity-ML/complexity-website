...
const projects = [
  ...
  },
  {
    ...
    description: "Deterministic token-identity routing with a dense shared expert path and narrow residual experts.",
    tags: ["Triton", "MoE", "LLM"],
    href: "https://github.com/Complexity-ML/complexity-deep",
    icon: Network,
    tone: "emerald",
  },
  {
  ...
  },
  {
    title: "Pacific-i64",
    kicker: "Open model",
    description: "A 1.5B-parameter language model produced through the Complexity architecture experiments.",
    tags: ["1.5B", "Model", "HuggingFace"],
