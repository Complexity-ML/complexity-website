      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        >
          ...
          >
            ...
            <br />
            with <span className="text-primary">Mu-Guided Dynamics</span> and{" "}
          ...
          >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 px-6 py-3 rounded-lg border border-border bg-secondary text-secondary-foreground font-medium hover:bg-secondary/80 transition-colors"
            >
