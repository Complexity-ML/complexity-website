...
export const KNOWLEDGE_DOCUMENTS: KnowledgeDocument[] = [
  ...
  },
  {
    ...
    content: [
      "The released 100M Agentic checkpoint was instruction-tuned for three epochs on 1,007,473 examples: 1,000,000 examples selected from the published Agentic SFT 2M corpus plus all 7,473 tokenized GSM8K train examples.",
      "The SFT mixture contains general conversations, verified compact reasoning, Python code, constraint following, direct answers with tools available, complete agentic trajectories, and supervised mathematical reasoning.",
      "The selected epoch-3 checkpoint at step 16,728 reached a matched validation loss of 1.162109 and perplexity of 3.20 over 13,303,759 supervised evaluation tokens.",
    ].join(" "),
    keywords: ["SFT", "training", "epochs", "1007473", "1M", "instruction", "tool use", "refinement"],
  },
  {
  ...
  },
  {
    ...
    content: [
      "The public demo serves AETHORIA-AI/TR-HASH-MoE-100M-Agentic-SFT-1M from the repository root through TR-Hash-i64.",
