...
const models: Model[] = [
  ...
  },
  {
    ...
    stats: [
      ...
      { value: "1,007,473", label: "SFT training examples" },
      { value: "3", label: "full-parameter SFT epochs" },
      { value: "1.162109", label: "matched eval loss" },
      { value: "3.20", label: "matched eval perplexity" },
    ],
    description: [
      ...
      "Full-parameter instruction tuning ran for three epochs on 1,007,473 examples: a deterministic stratified 1,000,000-example subset of the published Agentic SFT 2M corpus plus all 7,473 tokenized GSM8K train examples. The run uses the model's native 32K Agentic tokenizer and chat boundaries with a 2,048-token sequence length.",
      "The selected epoch-3 checkpoint at step 16,728 reached a matched validation loss of 1.162109 and perplexity 3.20 over 13,303,759 supervised evaluation tokens. Its mixture covers general conversations, verified compact reasoning, Python code, constraint following, direct answers with tools available, complete agentic trajectories and supervised mathematical reasoning.",
    ],
    links: [
      { label: "Try the 100M Agentic chat", href: "/ai-lab?model=v2" },
      { label: "Model weights", href: "https://huggingface.co/AETHORIA-AI/TR-HASH-MoE-100M-Agentic-SFT-1M" },
      ...
      { label: "Primary SFT corpus", href: "https://huggingface.co/datasets/AETHORIA-AI/TR-HASH-Agentic-SFT-2M" },
      { label: "GSM8K SFT supplement", href: "https://huggingface.co/datasets/AETHORIA-AI/GSM8K-TR-HASH-Agentic-32K" },
      { label: "Code", href: "https://github.com/Complexity-ML/complexity-framework" },
