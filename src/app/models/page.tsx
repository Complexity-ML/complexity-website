...
const models: Model[] = [
  {
    ...
    icon: Network,
    tone: "violet",
    status: "Released · Full SFT v2 live",
    ...
    stats: [
      ...
      { value: "69.04%", label: "PIQA acc_norm (SFT v2 epoch 2)" },
    ],
    description: [
      ...
      "The current assistant is the clean 32,004-token full-parameter SFT v2, trained directly from the refinement checkpoint for three epochs on the audited 500K unified mixture. Epoch 2 was promoted at 68.39% PIQA accuracy and 69.04% normalized accuracy as the best compromise between retained benchmarks, strict output formatting and free generation.",
    ...
    links: [
      ...
      { label: "Full SFT v2", href: "https://huggingface.co/AETHORIA-AI/TR-HASH-MoE-200M-160B-SFT-v2" },
      { label: "Live demo v2", href: "https://huggingface.co/spaces/Pacific-i64/TR-hash-tiny-v2" },
      { label: "Previous SFT v1", href: "https://huggingface.co/AETHORIA-AI/TR-HASH-MoE-200M-160B-SFT" },
      { label: "Previous demo v1", href: "https://huggingface.co/spaces/Pacific-i64/TR-hash-tiny" },
