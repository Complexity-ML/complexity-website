...
const models: Model[] = [
  ...
  },
  {
    ...
    stats: [
      ...
      { value: "500K", label: "SFT training examples" },
      { value: "25K", label: "held-out examples" },
      { value: "1.150476", label: "matched eval loss" },
      { value: "3.16", label: "matched eval perplexity" },
    ],
    description: [
    ...
    links: [
      ...
      { label: "SFT dataset", href: "https://huggingface.co/datasets/AETHORIA-AI/TR-HASH-Agentic-SFT-32K-500K" },
      { label: "Code", href: "https://github.com/Complexity-ML/complexity-framework" },
